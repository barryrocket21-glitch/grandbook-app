        ...
        <CardContent className="pt-8 pb-8 text-center space-y-4">
          ...
          <div className="rounded-lg border bg-muted/30 p-4 text-left text-sm space-y-2 max-w-md mx-auto">
            ...
            <ul className="text-xs text-muted-foreground space-y-1 list-disc list-inside">
              <li>Duplicate by <code className="font-mono text-zinc-500">external_order_id</code> otomatis di-skip saat bulk upload</li>
              <li>Order in-doubt masuk{' '}
                <Link href="/inbox/pending-review" className="text-zinc-500 hover:underline">/inbox/pending-review</Link>{' '}
                untuk review owner/admin
              </li>
              <li>Resi tidak match order → <Link href="/inbox/unmatched-resi" className="text-zinc-500 hover:underline">/inbox/unmatched-resi</Link></li>
            </ul>
          </div>
          <div className="pt-2">
